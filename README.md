...
> 400+ problems solved across LeetCode, GeeksforGeeks, CodeChef & HackerRank — practice code and learnings tracked here
...
| Area | Topics Covered |
|------|---------------|
| 🔢 **Data Manipulation** | NumPy, Pandas — cleaning, transforming, aggregating |
| 📉 **Visualization** | Matplotlib, Seaborn — charts, heatmaps, distributions |
| 🤖 **Machine Learning** | Scikit-learn — classification, regression, clustering |
| 🧠 **Deep Learning** | PyTorch, TensorFlow — neural networks (in progress) |
| 🌐 **Data Collection** | Web scraping, APIs, data pipelines |
...
<img src="https://github-readme-activity-graph.vercel.app/graph?username=vikramsumit&bg_color=0d1117&color=00d4ff&line=7c3aed&point=ffffff&area=true&hide_border=true&area_color=00d4ff20" width="100%"/>
